...
subtitle: "Informe Final para el Banco Interamericano de Desarrollo"
...
# ¿Chile gasta poco o mucho en seguridad?
...
# Seguridad: Primera Preocupación Nacional
...
# Respuesta institucional intensa
...
## Cómo analizamos el gasto

---

# Clasificación COFOG

## Estándar internacional del FMI

```
703 - ORDEN PÚBLICO Y SEGURIDAD
├── 7031 - Servicios de policía
├── 7032 - Protección contra incendios
├── 7033 - Tribunales de justicia
├── 7034 - Prisiones
├── 7035 - I+D en seguridad
└── 7036 - Otros servicios n.e.p.
```
...
Del PIB            ████████████████░░░░░░░░  1,43%
Del gasto total    ████████████████████████░  5,82%
Sin Prot. Social   ████████████████████████████░  8,13%
```
...
```
Gasto en seguridad (billones CLP 2024)
...
| Año | Policías | Justicia | Prisiones |
|-----|----------|----------|-----------|
| 2013 | 44% | 32% | 20% |
| 2017 | 44% | 32% | 20% |
| 2024 | 44% | 32% | 20% |
...
## Comparación por subfunción

---

# Policías: Posición media

```
Gasto per cápita PPA (US$)
...
**Alineado con la región, bajo vs. OCDE**

---

# Justicia: Levemente bajo
...
# Prisiones: COMPARATIVAMENTE ALTO
...
**Chile gasta +25% más que OCDE en prisiones**

**Señal de presión sobre sistema penitenciario**

---

# Bomberos: Modelo único
...
**Modelo de voluntariado con gasto público mínimo**
...
```
Distribución del gasto en seguridad
...
**Sin tocar dotaciones, el margen está en:**
- Equipamiento
- Tecnología
- Infraestructura
...
# No podemos evaluar eficiencia

## Cuatro problemas críticos

| Brecha | Consecuencia |
|--------|--------------|
| Sin mapeo programa→COFOG | No sabemos qué financia cada peso |
| Sin desagregación territorial | No identificamos inequidades |
| Registros no interoperables | No podemos seguir casos |
| Pocas evaluaciones de impacto | No sabemos qué funciona |
...
| 5 | Brechas de información | Imposible evaluar eficiencia |
...
## Trazabilidad presupuesto-resultados

**Diagnóstico:**
- No hay mapeo público programa→COFOG
- Imposible vincular gasto con desempeño

**Propuesta:**
- Publicar diccionario de correspondencia
- Panel trimestral: gasto + dotaciones + indicadores
...
**Diagnóstico:**
- Discusión presupuestaria sin indicadores de resultado

**Propuesta:**
Indicadores por institución:

| Institución | Indicador propuesto |
|-------------|---------------------|
| Carabineros | Tiempo respuesta promedio |
| PDI | Tasa de esclarecimiento |
| Fiscalía | Duración causas, tasa condena |
| Gendarmería | Hacinamiento, reincidencia |
...
**Propuesta:**
Este informe como **línea base** para programa permanente:

- Actualización anual de series COFOG
- Estudios de eficiencia técnica (cada 2 años)
...
```
         ...
         ────              ────              ────
Q1  ▓▓▓▓░░░░░░░░     ░░░░░░░░░░░░     ░░░░░░░░░░░░
    Trazabilidad     Evaluaciones     Indicadores
    (diccionario)    de impacto       de desempeño

Q2  ░░░░▓▓▓▓░░░░     ▓▓▓▓░░░░░░░░     ░░░░▓▓▓▓░░░░
    Fondo I+D        Benchmarking     Actualización
    (diseño)         regional         anual

Q3  ░░░░░░░░▓▓▓▓     ░░░░▓▓▓▓░░░░     ░░░░░░░░▓▓▓▓
    Panel de         Meta 5%          Informe
    indicadores      prevención       final
...
| **Total programa 3 años** | **US$ 700.000** |
...
| Línea | Descripción | Inversión |
|-------|-------------|-----------|
| **Programa de asistencia técnica** | Implementación de recomendaciones | US$ 700K |
| **Estudio regional comparado** | Extender análisis a 5 países LATAM | US$ 400K |
| **Laboratorio de innovación** | Piloto de intervenciones basadas en evidencia | US$ 500K |
| **Capacitación** | Diplomado en gestión de seguridad basada en evidencia | US$ 200K |
...
|-----|----------|----------|-----------|-------|
| 2013 | 1,58 | 1,15 | 0,72 | 3,60 |
| 2015 | 1,67 | 1,22 | 0,76 | 3,82 |
| 2017 | 1,76 | 1,28 | 0,81 | 4,03 |
| 2019 | 1,89 | 1,37 | 0,87 | 4,32 |
| 2021 | 1,72 | 1,24 | 0,79 | 3,91 |
...
|------|-------|----------|----------|-----------|
| Suiza | 1.180 | 520 | 380 | 180 |
| Noruega | 980 | 420 | 310 | 150 |
| Alemania | 720 | 310 | 250 | 95 |
| España | 580 | 260 | 200 | 75 |
...
# Anexo 4: Indicadores de resultado

## Propuesta de métricas

| Institución | Indicador | Línea base | Meta 2028 |
|-------------|-----------|------------|-----------|
| Carabineros | Tiempo respuesta (min) | 12 | 8 |
| PDI | Tasa esclarecimiento | 18% | 25% |
| Fiscalía | Duración causa (meses) | 14 | 10 |
